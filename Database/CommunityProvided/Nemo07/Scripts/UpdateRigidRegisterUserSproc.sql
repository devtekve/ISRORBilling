...
GO
/****** Object:  StoredProcedure [dbo].[_Rigid_Register_User]    Script Date: 11/4/2022 10:06:19 PM ******/
SET ANSI_NULLS ON
GO
...
END
	...
	VALUES (@UserJID, @szUserID, 11, @szPassword, 1, @szRegistrantIP, @szCountry, GETDATE(), @RegDate, 3, 3, 0, 0, 0, @szEmail, @szEmailCertificationStatus, @szEmailUniqueStatus , @szVIPUserType, @szVIPLv, @szVipExpireTime)
	IF (@@ERROR <> 0 OR @@ROWCOUNT <> 1)
BEGIN
ROLLBACK TRANSACTION
