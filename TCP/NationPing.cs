...
namespace ISRORBilling.Tcp
{
    ...
    {
        private const int PingBackTcpPort = 12989;      //SANS Internet Storm Center: port 12989   //SG security scan: port 12989 //this port should be added in "Gateway" Server.CFG
